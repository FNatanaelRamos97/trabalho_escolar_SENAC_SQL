...
use hospital;
ALTER TABLE atendimento DROP FOREIGN KEY atendimento_ibfk_6; 
ALTER TABLE internacao ADD atendimento_id INT NOT NULL;
ALTER TABLE internacao ADD FOREIGN KEY (atendimento_id) REFERENCES atendimento(id); 
